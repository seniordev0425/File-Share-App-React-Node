...
export function CodeFromSMS(props) {
  const {
    user, onSubmit, setTwoFactorMode,
    sendCodeState, resetSendTwoFactorCode, sendTwoFactorCodeBySMS,
  } = props

  const handleResend = () => sendTwoFactorCodeBySMS()
